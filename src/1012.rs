...
impl Solution {
    pub fn num_dup_digits_at_most_n(n: i32) -> i32 {
        ...
        for i in 0..k {
            ...
            // why put break after prev calculation?
            // say 8825, when we've done the first round 1xxx -> 7xxx
            // and we put 8 at first position(this is how used for)
            // now we can still calculate 81xx -> 87xx
            // but when we put the second 8 in it's position
            // we can not continue, because this is not the uniq case
            // and all following case need not calculate
